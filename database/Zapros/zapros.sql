...
INSERT INTO "USER_NAME" (USER_N_ID, USER_name, USER_Telegram) VALUES ('N1', 'Sif', 'qwerty:Telegram'), ('N2', 'NO-Sif', '')

-- Проводим проверку корректности ввода в таблицу USER_NAME.
INSERT INTO "USER_NAME" (USER_N_ID, USER_name, USER_Telegram) VALUES ('N9', 'Sim', 'qwerty:TelegramSim') -- Проверка несуществующего USER_N_ID.
INSERT INTO "USER_NAME" (USER_N_ID, USER_name, USER_Telegram) VALUES ('N5', 'Sif', '') -- Проверка уникальности USER_name.
INSERT INTO "USER_NAME" (USER_N_ID, USER_name, USER_Telegram) VALUES ('N5', 'SIF', '') -- Проверка уникальности по регистру. !! - Ошибка - !!
...
INSERT INTO "USER_PRIVAT" (USER_P_ID, USER_email, USER_password) VALUES ('P1', 'Sif@gmail.ua', 'qwerty'), ('P2', 'NO-Sif@gmail.ua', 'qwerty')

-- Проводим проверку корректности ввода в таблицу USER_PRIVAT.
INSERT INTO "USER_PRIVAT" (USER_P_ID, USER_email, USER_password) VALUES ('P9', 'oldil@email.su', 'qwerty') -- Проверка уникальности USER_P_ID.
INSERT INTO "USER_PRIVAT" (USER_P_ID, USER_email, USER_password) VALUES ('P3', 'Sif@gmail.ua', 'qwerty')   -- Проверка уникальности USER_email.
INSERT INTO "USER_PRIVAT" (USER_P_ID, USER_email, USER_password) VALUES ('P4', 'EMAIL@GMAIL.UA', 'qwerty') -- Проверка уникальности по регистру. !! - Ошибка - !!
