...
CREATE TABLE "USER_NAME"(                    -- Создаем таблицу.
	...
	USER_N_name VARCHAR (32) NOT NULL UNIQUE,  -- Создаем текстовый столбец, обязательно для заполнения, уникальное значение.
	USER_N_Telegram VARCHAR (40) NULL          -- Создаем текстовый столбец.
);
