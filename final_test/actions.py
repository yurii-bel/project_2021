...
from design.new_editUI_view import Ui_MainWindow
...
class form(QMainWindow):
    ...
    def addToDb(self):
        ...
        self.ui.lineEdit_spend_time.text())  # add text to db from spend_time
        self.model.setData(self.model.index(self.i,4), 
        self.current_date)  # add text of today's date to db 
        self.model.submitAll()
        self.i += 1
        self.ui.lcdNumber.display(self.i)
        print(self.ui.lineEdit_action_name.text())
    def delrow(self):
