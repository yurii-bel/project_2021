...
class ActionsUI(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.addEventUi.add_event_dateEdit.setMaximumDate(QDate(QDate.currentDate()))
        ...
        self.addEventUi.add_event_btn_cancel.clicked.connect(self.addEventUi.close)
        self.addEventUi.add_event_btn_exit.clicked.connect(self.addEventUi.close)
